...
# CRUD pour AppUser
# ----------------------
def create_app_user(db: Session, username: str, password: str, user_email: str): # noqa
    new_user = AppUser(username=username, password=password, user_email=user_email) # noqa
    db.add(new_user)
    db.commit()
    db.refresh(new_user)
    return new_user
